...
class ArxivPaper:
    ...
    def tldr(self) -> str:
        ...
        llm = get_llm()
        prompt = """
        You are an expert scientific summarizer. Given the title, abstract, introduction and the conclusion (if any) of a paper in latex format, generate a one-sentence TLDR summary in __LANG__. 
